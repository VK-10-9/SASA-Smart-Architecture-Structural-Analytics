    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 pt-20 py-12 relative z-10">
        ...
        >
          ...
          >
            <p>Need help with complex load combinations? <a href="mailto:info@sasa.engineer" className="text-primary underline">Contact our engineering team at info@sasa.engineer</a></p>
          </motion.div>
        </motion.div>
      </div>
    </div>
